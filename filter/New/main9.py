...
keywords_group1 = ["teaching", "cryptography", "dyslexia", "learning","teaching"]
keywords_group2 = ["teaching", "cryptography", "dyslexia", "learning","teaching"]
input_files = [f'input{i}new.csv' for i in range(1, 10)]  # Adjust range for the number of files
output_file = 'records_for_teaching.csv'
