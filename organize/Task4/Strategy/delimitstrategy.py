...
# Baca file CSV
input_filename = 'inputstrategy.csv'  # Ganti dengan path file input Anda
output_filename = 'output.csv'  # Ganti dengan path file output Anda

df = pd.read_csv(input_filename)

# Misahkan kolom 'B' yang dipisahkan oleh koma
df_exploded = explode(df, 'Strategy')
